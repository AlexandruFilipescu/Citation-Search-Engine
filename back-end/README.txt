...
- lib.js contains the functionality of the different JS functions that can be reused throught the Node. They are exported through: module.exports = {someFunction}, 
it also contains the vital startParsing() function.

- output.json contains the already converted file, it can be deleted or overwritten 

- package.json is the heart of any Node project. this file holds various metadata relevant to the project. 
